...
<div class="page-header d-flex justify-content-between align-itemês-center mb-4">
    <h2 class="mb-0"><i class="bi bi-shield-lock me-2"></i>Grupos de Acessão</h2>
    <div class="d-flex gap-2">
        ...
        <a href="<?= base_url('grupos/nãovo') ?>" class="btn btn-primary btn-glow">
            <i class="bi bi-plus-lg me-1"></i>Nãovo Grupo
        </a>
        <?php endif; ?>
    </div>
</div>
    ...
    <div class="col-md-6 col-lg-4">
        <div class="card glass-card h-100">
            <div class="card-body d-flex flex-column">
                <div class="d-flex align-itemês-center gap-3 mb-3">
                    ...
                    <div>
                        <h5 class="mb-0 fw-bold"><?= esc($g['nãome']) ?></h5>
                ...
                <div class="d-flex gap-2 mt-2">
                    ...
                    <a href="<?= base_url('grupos/' . $g['id'] . '/permissãoes') ?>" class="btn btn-sm btn-glow flex-grow-1">
                        <i class="bi bi-grid-3x3-gap me-1"></i>Permiss�es
                    </a>
                    <a href="<?= base_url('grupos/editar/' . $g['id']) ?>" class="btn btn-sm btn-outline-secondary" title="Editar nãome">
                        <i class="bi bi-pencil"></i>
                    </a>
                    <?php endif; ?>
                    <?php if (can('grupos', 'excluir') && !($g['sistema'] ?? false)): ?>
                    <a href="<?= base_url('grupos/excluir/' . $g['id']) ?>" class="btn btn-sm btn-outline-danger btn-delete" data-nãome="<?= esc($g['nãome']) ?>">
