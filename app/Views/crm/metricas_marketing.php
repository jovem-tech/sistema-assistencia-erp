...
$canEditarPeriodo = function_exists('can') ? can('crm', 'editar') : true;
...
<div class="page-header d-flex justify-content-between align-items-center mb-3">
    <div class="d-flex align-items-center gap-3">
        <h2 class="mb-0"><i class="bi bi-bar-chart-line me-2"></i>CRM - MÃ©tricas Marketing</h2>
...
<div class="crm-mkt-grid">
                                        ...
                                        <tr>
                                            <td data-label="Responsavel">
                                                <div class="d-flex align-items-center gap-2">
                                                    ...
                                                    <div>
                                                        <div class="fw-semibold"><?= esc($rankingRow['responsavel_nome'] ?? 'NÃ£o atribuÃ­do') ?></div>
    ...
    <div class="card">
        <div class="card-body">
            <details>
                <summary class="fw-semibold">ConfiguraÃ§Ã£o de janelas de engajamento</summary>
                ...
                <?php if (!$supportsEngajamento): ?>
                    <div class="alert alert-warning py-2 small mb-2">Estrutura de engajamento ainda nÃ£o migrada.</div>
                <?php endif; ?>
