...
<style>
.cm-inline-orcamento-modal .modal-dialog {
...
.cm-inline-orcamento-modal .modal-content {
    height: 100vh;
    border-radius: 0;
}

.cm-inline-orcamento-modal .modal-body {
    padding: 0 !important;
    max-height: none !important;
    overflow: hidden !important;
}

.cm-inline-orcamento-frame {
    width: 100%;
...
<div class="cm-page-shell" data-sidebar-auto-collapse="hover">
                ...
                <div class="card glass-card cm-panel mb-0">
                    <div class="card-body p-0 d-flex flex-column gap-0">
                        ...
                        <div class="cm-quick-filter-bar px-3 pt-2 pb-1">
                            ...
                            <button type="button" class="btn btn-sm btn-outline-secondary cm-quick-filter-btn" data-cm-quick-filter="unread">Não lidas</button>
                        ...
                        <div class="cm-thread-header-actions" id="cmChatActionsBar">
                            ...
                            <div class="dropdown cm-thread-actions-dropdown">
                                <button
                                    ...
                                    aria-label="Abrir menu de ações da conversa"
                                >
                                ...
                                <ul class="dropdown-menu dropdown-menu-end cm-chat-actions-menu cm-thread-actions-menu">
                                    ...
                                    <li><h6 class="dropdown-header">Ações operacionais</h6></li>
                                    <li>
                                    ...
                                    <li><hr class="dropdown-divider"></li>
                                    <li><h6 class="dropdown-header">Ações de fila</h6></li>
                                    <li>
    ...
    <div class="modal fade cm-inline-orcamento-modal" id="cmInlineOrcamentoModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-fullscreen">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="cmInlineOrcamentoModalTitle">Novo Orçamento</h5>
                    <a
                        href="#"
                        class="btn btn-sm btn-outline-secondary me-2 d-none"
                        id="cmInlineOrcamentoOpenFull"
                        target="_blank"
                        rel="noopener"
                    >
                ...
                <div class="modal-body p-0 position-relative">
                    <div class="cm-inline-orcamento-loading d-none" id="cmInlineOrcamentoModalLoading">
                        <div class="spinner-border text-primary" role="status" aria-hidden="true"></div>
                        <span class="small text-muted">Carregando orçamento...</span>
                    </div>
                    <iframe id="cmInlineOrcamentoModalFrame" class="cm-inline-orcamento-frame" title="Orçamento" src="about:blank"></iframe>
                </div>
            </div>
        </div>
    </div>
