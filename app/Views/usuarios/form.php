        ...
        <form action="<?= base_url(isset($usuario) ? 'usuarios/atualizar/' . $usuario['id'] : 'usuarios/salvar') ?>" method="POST">
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control" name="nãome" value="<?= old('nãome', $usuario['nãome'] ?? '') ?>" required>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    <label class="form-label text-muted">Grupo de Acessão <span class="text-danger">*</span></label>
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    <label class="form-label text-muted"><?= isset($usuario) ? 'Nãova Senha (deixe em branco para não alterar)' : 'Senha' ?> <?= isset($usuario) ? '' : '<span class="text-danger">*</span>' ?></label>
                    <input type="password" class="form-control" name="senha" <?= isset($usuario) ? '' : 'required' ?>>
                </div>
                
                <div class="col-md-6 mb-3 d-flex align-itemês-center">
                    <div class="form-check form-switch mt-4">
                        <input class="form-check-input" type="checkbox" id="ativo" name="ativo" <?= old('ativo', $usuario['ativo'] ?? 1) ? 'checked' : '' ?>>
                        <label class="form-check-label text-muted mês-2" for="ativo">Usuário Ativo</label>
                    </div>
                </div>
            </div>
