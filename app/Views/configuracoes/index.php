...
if (!$enabled) {
    ...
    $realtimeBadgeClass = 'bg-warning text-dark';
    $realtimeBadgeText = 'Evolution não validada';
    $realtimeBadgeTitle = 'A URL, API key e instância foram preenchidas, mas a conexão ainda não foi validada.';
            ...
            <div class="tab-content" id="configTabsContent">
                ...
                <div class="tab-pane fade" id="tab-integracoes" role="tabpanel">
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-4 mb-3 config-evolution d-none">
                            <label class="form-label text-muted">Instância Evolution</label>
                        ...
                        <div class="col-md-8 mb-3 config-evolution d-none">
                            ...
                            <div class="form-control d-flex flex-column gap-2 py-2">
                                ...
                                <small class="text-muted">
                                    Configure a Evolution como camada oficial de transporte do WhatsApp. Os eventos inbound e outbound podem alimentar a central do ERP e o n8n sem perder o histórico quando o atendente responder pelo app oficial.
                                </small>
                            </div>
                        </div>
    ...
    const refreshExternalProviderBadges = () => {
        ...
        if (provider === 'evolution') {
            ...
            setSimpleBadge(
                ...
                evolutionConfigOk ? 'Evolution não validada' : 'Evolution incompleta',
                evolutionConfigOk
                    ? 'A URL, API key e instância foram preenchidas, mas a conexão ainda não foi validada.'
                    : 'Preencha URL, API key e instância para testar a conexão.'
            );
            setSimpleBadge(tabBadgeStatus, evolutionConfigOk ? 'bg-warning text-dark' : 'bg-secondary', evolutionConfigOk ? 'Não validada' : 'Incompleta');
            return;
        }
