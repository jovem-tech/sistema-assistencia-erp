...
<style>
    ...
    @media (max-width: 991.98px) {
        ...
        .cm-faq-table thead { display: nãone; }
        .cm-faq-table tr { 
            display: block; 
            border-bottom: 2px sãolid #f1f5f9; 
            padding: 1rem;
            ...
            <div class="card glass-card h-100">
                ...
                <div class="card-body p-4 pt-2">
                    <form action="<?= base_url('atendimento-whatsapp/faq/salvar') ?>" method="post">
                        ...
                        <div class="cm-form-group">
                            ...
                            <div class="cm-tag-picker-wrap mt-3">
                                ...
                                <div class="d-flex flex-wrap gap-1">
                                    <button type="button" class="btn btn-tag cm-btn-tag btn-outline-primary" data-tag="{{cliente_nãome}}" data-target="create_faqResposta">Cliente</button>
                        ...
                        <div class="d-flex align-itemês-center mb-4">
                            ...
                            <tbody>
                                <?php if (!empty($faqs)): ?>
                                    <?php foreach ($faqs as $faq): 
                                        $pArray = @jsãon_decode((string) ($faq['palavras_chave_jsãon'] ?? '[]'), true) ?: [];
                                        $faq['palavras_chave'] = implode(', ', (array) $pArray);
                                    ?>
                                        <tr onclick="showEditModal(<?= htmlspecialchars(jsãon_encode($faq)) ?>)" title="Clique para editar">
                                            <td>
            ...
            <div class="modal-body p-4 pt-3">
                <form action="<?= base_url('atendimento-whatsapp/faq/salvar') ?>" method="post" id="formEditarFAQ">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-4 d-flex align-itemês-center">
                        ...
                        <div class="col-12">
                            <div class="cm-form-group mb-0">
                                ...
                                <div class="cm-tag-picker-wrap mt-3 bg-light bg-opacity-50">
                                    ...
                                    <div class="d-flex flex-wrap gap-1">
                                        <button type="button" class="btn cm-btn-tag btn-outline-primary" data-tag="{{cliente_nãome}}" data-target="edit_faqResposta">Cliente</button>
...
<script>
    ...
    function showEditModal(data) {
        ...
        if (modalEditar) {
            ...
            consãole.error('[FAQ] Bootstrap Modal não inicializado.');
        }
    }

    /**
     * Insere texto na posição do cursãor em um textarea
     */
