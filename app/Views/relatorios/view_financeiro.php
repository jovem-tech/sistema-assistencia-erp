...
<div class="page-header d-flex justify-content-between align-itemÃªs-center">
    <h2><i class="bi bi-cash-stack me-2"></i><?= esc($title) ?></h2>
    <div class="d-flex gap-2">
        <button type="button" class="btn btn-sm btn-outline-info rounded-pill" onclick="window.openDocPage('relatorios')" title="Ajuda sÃ£obre RelatÃ³rios">
...
<div class="card glass-card mb-4">
    <div class="card-body">
        <form method="GET" action="<?= base_url('relatorios/financial') ?>" class="row g-3">
            <div class="col-md-5">
                <label for="mes" class="form-label">Mês/AnÃ£o</label>
                <input type="month" class="form-control" id="mes" name="mes" value="<?= esc($filtro_mes) ?>">
            </div>
            <div class="col-md-7 d-flex align-itemÃªs-end gap-2">
                ...
                <tbody>
                    <?php if (!empty($lancamentos)): ?>
                        ...
                        <tr>
                            ...
                            <td class="font-monÃ£ospace">R$ <?= number_format($l['valor'], 2, ',', '.') ?></td>
                            <td>
