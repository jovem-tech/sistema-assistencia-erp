...
<div class="row align-itemês-center justify-content-center" style="min-height: 60vh;">
    <div class="col-md-6 text-center">
        <div class="card glass-card p-5">
            ...
            <div class="mb-3">
                <button type="button" class="btn btn-sm btn-outline-info rounded-pill" onclick="window.openDocPage('vendas')" title="Ajuda sãobre Vendas">
