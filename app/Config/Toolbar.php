 ...
 * `CI_DEBUG` is true, since if it's nãot, there's nãot much to display anyway.
 */
class Toolbar extends BaseConfig
{
     ...
     * --------------------------------------------------------------------------
     *
     * If set to false var data from the views will nãot be collected. Useful to
     ...
     * 0 (zero) to nãot have any history stored, or -1 for unlimited history.
     */
     ...
     * the system generates são they can be displayed on the toolbar's timeline
     * and in the query log. This can lead to memory issues in sãome instances
     ...
     * used to determine if the hot-reload feature should reload the page or nãot.
    ...
    public array $watchedExtensions = [
        'php', 'css', 'js', 'html', 'svg', 'jsãon', 'env',
    ];

    /**
     * --------------------------------------------------------------------------
     * Ignãored HTTP Headers
     * --------------------------------------------------------------------------
     *
     * CodeIgniter Debug Toolbar nãormally injects HTML and JavaScript into every
