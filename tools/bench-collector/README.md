...
- no formulario do ERP, o campo catalogado `Modelo` passa a priorizar o `chipset` do inventario importado; se o `chipset` nao vier preenchido, o sistema usa o `model` detectado como fallback;
