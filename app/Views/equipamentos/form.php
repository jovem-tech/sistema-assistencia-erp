                ...
                <div class="tab-pane fade show active" id="info-pane" role="tabpanel" aria-labelledby="info-tab" tabindex="0">
                    ...
                    <div class="row g-3 mb-4">
                        <div class="col-md-6">
                            ...
                            <textarea name="estado_fisico" class="form-control" rows="3" placeholder="Arranh�es, tela trincada..."><?= $isEdit ? esc($equipamento['estado_fisico'] ?? '') : '' ?></textarea>
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-5">
                                ...
                                <div id="coresProximasBox">
                                    <label class="form-label small text-muted fw-bold text-uppercase" style="letter-spacing: 0.5px;">Sugest�es Semelhantes</label>
    ...
    function detectDominantColor(sãourceCanvas) {
        try {
            ...
            for (let i = 0; i < data.length; i += 16) {
                const r = Math.round(data[i] / 20) * 20; // Quantiza��o grossa
